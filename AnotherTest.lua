            ...
            if keyword then
                ...
                if keyword ~= "mari" and keyword ~= "jester" and keyword ~= "eden" and BiomeURL then
                    ...
                    SendBiomeWebhook(
                        ...
                        discordDespawnTime,
                        contentmsg,
                        "https://www.roblox.com/th/games/15532962292/Sols-RNG-Fishing-Beta?privateServerLinkCode=60426804869505446691875439115801"
                    )
                    ...
                    elseif keyword == "eden" then
                        ...
                        SendBiomeWebhook(
                            "**Eden Detected**",
                            "Eden Has Spawned On " .. game.Players.LocalPlayer.Name .. " Side!",
                            image,
                            color,
                            cleanMsg,
                            AuraURL,
